struct RerenderingViewer<Handle, RenderState> {
    padding: f32,
    width: Length,
    height: Length,
    min_scale: f32,
    ...
    handle: Handle,
    state: RenderState,
    render_fn: fn(RenderState) -> Handle,
}

impl<Handle, RenderState> RerenderingViewer<Handle, RenderState> {
    /// Creates a new [`Viewer`] with the given [`State`].
    pub fn new(handle: Handle, state: RenderState, render_fn: fn(RenderState) -> Handle) -> Self {
        Viewer {
            padding: 0.0,
            width: Length::Shrink,
...
impl<Message, Renderer, Handle, RenderState> Widget<Message, Renderer> for Viewer<Handle, RenderState>
where
