...
fn bench_color_space(c: &mut Criterion) {
    ...
    group.bench_with_input("palette evaluation", speeds_ref, |b: &mut Bencher, speeds: &[f64]| {
    ...
    group.bench_with_input("linear<f64> to srgb<u8> conversion", colors_ref, |b: &mut Bencher, colors: &[LinearRGB]| {
